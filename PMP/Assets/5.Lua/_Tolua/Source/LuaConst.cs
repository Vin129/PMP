...
{
    public static string luaDir = Application.dataPath + "/5.Lua/_LuaKit/ToLua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/5.Lua/_Tolua/ToLua/Lua";        //tolua lua文件目录
