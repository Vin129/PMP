...
namespace LuaKit {
	...
	public class ScriptBaseSetting
	{
		...
		public static string SETTING_DATA_PATH = Application.dataPath + "/5.Lua/_LuaKit/ScriptKitData/BaseSetting.json";
#region  EditorKey 
...
#region ToLua	
		...
		public static string LUA_DIR = Application.dataPath + "/5.Lua/_LuaKit/ToLua/Lua";                //lua逻辑代码目录
		public static string TOLUA_DIR = Application.dataPath + "/5.Lua/_LuaKit/ToLua/Lua";        //tolua lua文件目录
#endregion
